...
/**
 * HeroSearchBar Component (Thanh tìm kiếm chính)
 * Thu thập các tiêu chí tìm kiếm từ người dùng: Địa điểm, Ngày, Số lượng khách, Khoảng giá.
 * Truyền kết quả tìm kiếm (onSearch) lên component cha (Home.js) để gọi API hoặc filter dữ liệu.
 */
