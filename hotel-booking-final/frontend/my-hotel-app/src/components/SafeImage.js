...
/**
 * SafeImage Component
 * Hiển thị hình ảnh một cách an toàn. 
 * Hỗ trợ một chuỗi các fallback (ảnh dự phòng). Nếu ảnh lỗi, nó tự động tải ảnh kế tiếp.
 * Nếu tất cả ảnh đều lỗi, nó hiển thị một khối màu nền (placeholder) an toàn để UI không bị vỡ.
 */
