 ...
 * Hiển thị ở mọi trang, chứa: Logo, Chế độ xem khách (Guest), Nút đổi nền Sáng/Tối (ThemeToggle), 
 * và phần thông tin User (nếu đã đăng nhập thì hiện tên/menu con, chưa thì hiện nút Đăng nhập).
 */
