...
/**
 * BookingPage Component (Trang Đặt Phòng)
 * Cho phép người dùng xác nhận thông tin và thanh toán.
 * Hỗ trợ 2 chế độ:
 * 1. Đã đăng nhập: Lấy thông tin từ AuthContext và liên kết với tài khoản.
 * 2. Khách vãng lai (Guest mode): Bắt buộc nhập tên và email, đặt phòng không cần tài khoản.
 */
export default function BookingPage() {
  ...
  /**
   * Hàm xử lý sự kiện khi người dùng bấm nút "Xác nhận đặt phòng"
   */
  const handleBook = async (event) => {
    ...
    setLoading(true);
    try {
      // Gửi dữ liệu đặt phòng lên Backend API
