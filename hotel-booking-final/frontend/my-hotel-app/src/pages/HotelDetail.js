...
/**
 * HotelDetail Component (Trang Chi tiết Khách sạn)
 * Cho phép xem hình ảnh, mô tả, bản đồ, đánh giá, và đặc biệt là Danh sách phòng (Rooms).
 * Người dùng có thể kiểm tra phòng trống theo ngày check-in / check-out.
 */
export default function HotelDetail() {
  ...
  useEffect(() => {
    // Gọi API lấy dữ liệu chi tiết khách sạn (Kèm danh sách phòng và số lượng phòng trống)
