...
/**
 * MyBookings Component (Trang Lịch sử đặt phòng của tôi)
 * Cho phép người dùng xem danh sách các phòng đã đặt, hủy đặt phòng (nếu đang pending),
 * và gửi đánh giá (Feedback) sau khi đã checkout.
 */
